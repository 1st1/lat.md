...
const cache = join(root, 'lat.md', '.cache');
...
const metadata = {
  ...
  notes:
    'Original released search/index/parser source; embedding crate and local implementation identical to b139199, historical b139199 loader build reused; main dependency links except historical local embed and model package. Native limit5 and10 queried independently. Index timing diagnostic only; concurrent work may affect it.',
};
